...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@UBAYAHOTEL.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+62 (31)397-1024</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">UBAYA <span>HOTEL</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">UBAYA HOTEL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our UBAYA HOTEL</h3> 
...
<!-- //gallery -->
	 <!-- rooms & rates -->
      <div class="plans-section" id="rooms">
				...
				<?php
				$query = mysqli_query($con, "select * from roomtype");
				while($data = mysqli_fetch_assoc($query)){
					$id = $data['id'];
					$name = mysqli_real_escape_string($con, $data['name']);
					$price = $data['price'];
					$pic = mysqli_real_escape_string($con, $data['pic']);
				?>
					...
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">	
								<h3><span>Rp.</span><?php echo number_format($price,2,',','.');?></h3>						
								<a href="admin/reservation.php?id=<?php echo $id;?>" >Book Now</a>
							</div>
						</div>
					</div>
				</div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+62 (31)397-1024</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@UBAYAHOTEL.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Tamiajeng, Trawas, Indonesia.</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2017 UBAYA HOTEL . All Rights Reserved | Design by <a href="index.php">UBAYA HOTEL</a> </p>
		    </div>
<!--/footer -->
<!-- js -->

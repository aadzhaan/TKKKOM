                        ...
                        <div class="panel-body">
                            <div class="table-responsive" style="overflow-x:auto;">
                                <table class="table">
									...
									{	
                                        $identity = my_simple_crypt($trow['identitynumber'],'d');
										$co = $trow['stat']; 
                                        $troom =  mysqli_real_escape_String($con, $trow['TRoom']);
                                        $troomq = mysqli_query($con, "select name as name from roomtype where id = '$troom'");
                                        $troomres = mysqli_fetch_assoc($troomq);
                                        $trooms = $troomres['name'];
										if($co == "Not Confirm")
										{
											echo"<tr>
												<th>".$no++."</th>
                                ...
                                <div class="panel panel-info">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse" style="height: 0px;">
										...
										{		
											...
											if($br == "Confirm")
											{
												$fid = mysqli_real_escape_String($con, $mrow['id']);
                                                $ftroom = mysqli_real_escape_String($con, $mrow['TRoom']);
                                                $qryroom = mysqli_query($con, "select name from roomtype where id='$ftroom'");
                                                $troomq = mysqli_fetch_array($qryroom);
                                                $troom = $troomq['name'];

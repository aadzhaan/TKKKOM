										...
										while($row = mysqli_fetch_array($re))
										{
											...
											if($id % 2 ==1 )
											{
												echo"<tr class='gradeC'>
													...
													<td>".$row['cout']."</td>
													<td>".$row['meal']."</td>
													<td>Rp.".number_format($row['ttot'],2,',','.')."</td>
													<td>Rp.".number_format($row['mepr'],2,',','.')."</td>
													<td>Rp.".number_format($row['fintot'],2,',','.')."</td>
													<td><a href=print.php?pid=".$id ." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Pay</button></td>
													</tr>";
											}
											else
											{

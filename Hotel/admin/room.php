						...
						<form name="form" method="post">
                            <div class="form-group">
                                            ...
                                            <select name="troom"  class="form-control" required>
												...
												<option value="6">KING ROOM</option>
                                            </select>
                              </div>
                              <div class="form-group">
                                            <label>Room Number</label>
                                            <input name="numb" type ="text" class="form-control">
							...
							<?php
							 ...
							 if(isset($_POST['add']))
							 {
										...
										$check="SELECT * FROM room WHERE type = '$room' AND 'number' = '$numb'";
										...
										$sql ="INSERT INTO `room`( `type`, `number`,`floor`,`place`) VALUES ('$room','$numb','$floor','$place')" ;
